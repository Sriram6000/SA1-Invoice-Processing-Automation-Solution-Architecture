...
| Previous: [Low Volume - SharePoint-Based Architecture](03-p3-low-volume-sharepoint-based-architecture.md) | Next: [Future Roadmap](architecture-patterns/future-roadmap.md) |
|-|-|
